/* Sample program for Project 3: Evaluating Sales Promotion Effects */
...
/* The library name specification is for SAS OnDemand for Academics */

/* Set the number of lines per page in the output file */
options ps=60;

/* Define the libary name first in order to locate the data files. */
/* You need to change the path according to the folder under your account */
/* or on your computer. */
